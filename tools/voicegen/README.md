...
# the shipped-sample workflow: author a ~50 s passage cycling seven
# languages, synthesize three specific voices, verify each take
...
voice. Regenerate flagged takes (`--overwrite`).
